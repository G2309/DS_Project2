  ...
  return (
    <div className="min-h-screen bg-white p-6 pt-24">
      <div className="max-w-5xl mx-auto">
        <div className="mb-8">
          <h2 className="text-4xl font-bold text-accent mb-2">Research Information</h2>
          <p className="text-muted-foreground">RSNA 2022 Cervical Spine Fracture Detection Challenge</p>
        </div>
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <div className="bg-primary/5 p-3 rounded-lg border border-primary/20">
                  <p className="text-foreground/70 text-xs mb-1 font-medium">Total Images</p>
                  <p className="text-2xl font-bold text-primary">5,000+</p>
                </div>
                <div className="bg-primary/5 p-3 rounded-lg border border-primary/20">
                  <p className="text-foreground/70 text-xs mb-1 font-medium">Patients</p>
                  <p className="text-2xl font-bold text-primary">1,200+</p>
                </div>
                <div className="bg-red-50 p-3 rounded-lg border border-red-300">
                  <p className="text-foreground/70 text-xs mb-1 font-medium">Positive Cases</p>
                  <p className="text-2xl font-bold text-red-600">800</p>
                </div>
                <div className="bg-accent/5 p-3 rounded-lg border border-accent/20">
                  <p className="text-foreground/70 text-xs mb-1 font-medium">Negative Cases</p>
                  <p className="text-2xl font-bold text-accent">4,200</p>
                </div>
              </div>

              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-primary/5 border border-primary/20 rounded-lg p-4">
                  <h4 className="font-semibold text-primary mb-2">Vertebrae Coverage</h4>
                  ...
                  <ul className="text-foreground/75 text-sm space-y-1">
                ...
                <div className="bg-accent/5 border border-accent/20 rounded-lg p-4">
                  <h4 className="font-semibold text-accent mb-2">Data Characteristics</h4>
                  <p className="text-foreground/75 text-sm mb-2">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div className="bg-white p-4 rounded-lg border-l-4 border-primary">
                  <h4 className="font-semibold text-foreground mb-2">1. Data Preprocessing</h4>
                ...
                <div className="bg-white p-4 rounded-lg border-l-4 border-primary">
                  <h4 className="font-semibold text-foreground mb-2">2. Architecture Selection</h4>
                  <p className="text-foreground/75 text-sm">
                ...
                <div className="bg-white p-4 rounded-lg border-l-4 border-accent">
                  <h4 className="font-semibold text-foreground mb-2">3. Training Strategy</h4>
                  <p className="text-foreground/75 text-sm">
                ...
                <div className="bg-white p-4 rounded-lg border-l-4 border-accent">
                  <h4 className="font-semibold text-foreground mb-2">4. Ensemble Methods</h4>
                  <p className="text-foreground/75 text-sm">
                ...
                <div className="bg-white p-4 rounded-lg border-l-4 border-primary">
                  <h4 className="font-semibold text-foreground mb-2">5. Validation & Testing</h4>
                  <p className="text-foreground/75 text-sm">
          ...
          <Card className="border-accent/20 shadow-sm hover:shadow-md transition-shadow">
            <CardHeader>
              ...
              <CardDescription>Comprehensive evaluation metrics on test set</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-2 gap-4 mb-4">
                <div className="space-y-2">
                  <h4 className="text-foreground font-semibold text-sm">Classification Metrics</h4>
                  <div className="space-y-2">
                    <div className="flex justify-between items-center p-2 bg-white rounded border border-primary/20">
                      <span className="text-foreground/70 text-sm">Best Model Accuracy</span>
                      <span className="text-primary font-bold text-lg">96.1%</span>
                    </div>
                    <div className="flex justify-between items-center p-2 bg-white rounded border border-primary/20">
                      <span className="text-foreground/70 text-sm">Sensitivity (Recall)</span>
                      <span className="text-red-600 font-bold text-lg">93.5%</span>
                    </div>
                    <div className="flex justify-between items-center p-2 bg-white rounded border border-primary/20">
                      <span className="text-foreground/70 text-sm">Specificity</span>
                      <span className="text-accent font-bold text-lg">98.9%</span>
                    </div>
                  </div>
                </div>

                <div className="space-y-2">
                  <h4 className="text-foreground font-semibold text-sm">Statistical Measures</h4>
                  <div className="space-y-2">
                    <div className="flex justify-between items-center p-2 bg-white rounded border border-primary/20">
                      <span className="text-foreground/70 text-sm">AUC-ROC</span>
                      <span className="text-primary font-bold text-lg">0.981</span>
                    </div>
                    <div className="flex justify-between items-center p-2 bg-white rounded border border-primary/20">
                      <span className="text-foreground/70 text-sm">F1 Score</span>
                      <span className="text-primary font-bold text-lg">0.945</span>
                    </div>
                    <div className="flex justify-between items-center p-2 bg-white rounded border border-primary/20">
                      <span className="text-foreground/70 text-sm">Inference Time</span>
                      <span className="text-primary font-bold text-lg">{"<"} 500ms</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-primary/5 p-4 rounded-lg border border-primary/20">
                  <p className="font-semibold text-primary mb-1">Lead Researchers</p>
                  <ul className="text-foreground/75 text-sm space-y-2">
                ...
                <div className="bg-accent/5 p-4 rounded-lg border border-accent/20">
                  <p className="font-semibold text-accent mb-1">Contributors</p>
                  <ul className="text-foreground/75 text-sm space-y-2">
              ...
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-4">
                <p className="text-foreground/75 text-sm">
                  <span className="font-semibold text-primary">Institution:</span> Medical AI Research Center,
                  affiliated with multiple leading academic medical centers. Supported by grants from the NIH and
                  computational resources from cloud computing partners.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-accent/20 shadow-sm hover:shadow-md transition-shadow">
            ...
            <CardContent className="space-y-3">
              <div className="space-y-2">
                <h4 className="font-semibold text-foreground text-sm mb-2">Challenge Resources</h4>
                <a
                  href="#"
                  className="flex items-center gap-2 p-3 rounded bg-white hover:bg-primary/5 transition-colors text-primary group border border-primary/20 hover:border-primary/40"
                >
                  <ExternalLink className="w-4 h-4 group-hover:text-accent" />
                  <div>
                    <p className="text-sm font-medium">RSNA Challenge Official Page</p>
                    <p className="text-xs text-muted-foreground">Detailed challenge information and leaderboard</p>
                  </div>
                </a>
              </div>

              <div className="space-y-2">
                <h4 className="font-semibold text-foreground text-sm mb-2">Technical Documentation</h4>
                <a
                  href="#"
                  className="flex items-center gap-2 p-3 rounded bg-white hover:bg-primary/5 transition-colors text-primary group border border-primary/20 hover:border-primary/40"
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Complete technical approach and results</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Data specifications and acquisition protocols</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Source code and model implementations</p>
                  </div>
                </a>
              </div>

              <div className="space-y-2 mt-4 pt-4 border-t border-primary/10">
                <h4 className="font-semibold text-foreground text-sm mb-2">Relevant Publications</h4>
                <p className="text-foreground/75 text-sm">
                  <span className="font-semibold text-primary">Deep Learning for Medical Imaging:</span> Comprehensive
                  survey of CNN and Vision Transformer applications in radiology, 2024
                </p>
                <p className="text-foreground/75 text-sm">
                  <span className="font-semibold text-accent">Cervical Spine Injury Detection:</span> Clinical
                  validation of automated systems for trauma imaging, 2023
                </p>
              </div>
            </CardContent>
          </Card>
